---
título: "resultados"
authors: "rodrigo rolim veras, beatriz leandro bonafini, marcos antonio nespolo junior"
date: "2024-04-09"
output: pdf_document
---
...
O melhor modelo foi random forest com acurácia de 0.918 e kappa de 0.8987. A métrica utilizada foram a acurácia e kappa.
...
```{r}
regression.spurr <- nls(VOL ~ b0 + b1*DAP*DAP*HT, data=regression.treino, start=list(b0=0.5, b1=0.5))
```
...
Com base nas métricas, o modelo que se saiu melhor foi o RandomForest, com
R2 igual 0.8223603, Erro padrão estimativa de 0.1376052 e Erro padrão de estima-
tiva em porcentagem de 10.42195
